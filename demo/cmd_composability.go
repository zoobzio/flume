...
contract := plugz.GetContract[SecurityRequest](securityPipeline)
contract.Register(
    checkAuthentication,
    validateSession,
)`)
	...
	authContract := plugz.GetContract[SecurityRequest](securityPipeline)
...
contract.Register(
	...
	authzContract := plugz.GetContract[SecurityRequest](securityPipeline)
...
contract.Register(
	...
	platformContract := plugz.GetContract[SecurityRequest](securityPipeline)
...
contract.Register(
	...
	complianceContract := plugz.GetContract[SecurityRequest](securityPipeline)
	...
	anyContract := plugz.GetContract[SecurityRequest](securityPipeline)
