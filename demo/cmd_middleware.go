...
var middlewareCmd = &cobra.Command{
	...
	Long:  `Demonstrates building HTTP-like middleware chains with plugz.`,
...
middlewareContract := plugz.GetContract[Request](APIMiddlewareV1)
...
secureContract := plugz.GetContract[Request](secureKey)
...
publicContract := plugz.GetContract[Request](publicKey)
...
if request.Path == "/health" {
    ...
    healthContract := plugz.GetContract[Request](healthKey)
