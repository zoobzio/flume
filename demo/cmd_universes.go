...
standard := plugz.GetContract[Transaction](StandardContractV1)
premium  := plugz.GetContract[Transaction](PremiumContractV1)
highRisk := plugz.GetContract[Transaction](HighRiskContractV1)`)
	...
	standardContract := plugz.GetContract[Transaction](StandardContractV1)
	...
	premiumContract := plugz.GetContract[Transaction](PremiumContractV1)
	...
	highRiskContract := plugz.GetContract[Transaction](HighRiskContractV1)
...
wrongPipeline := plugz.GetContract[Transaction](wrongKey)
