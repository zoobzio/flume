...
Thank you for your interest in contributing to flume! This guide will help you get started.
...
2. Clone your fork: `git clone https://github.com/yourusername/flume.git`
...
New processor builders should:
- Follow the existing pattern in `builders.go`
...
- Extend the `Node` type appropriately
- Include validation rules
- Add builder support
- Document the YAML/JSON format
...
Example: `feat(schema): add support for custom connector types`
...
Thank you for contributing to flume!
