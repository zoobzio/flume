...
Flume integrates with [Capitan](https://github.com/zoobz-io/capitan) for comprehensive observability.
...
- [Events Reference](../4.reference/4.events.md) - Complete event list
- [Capitan Documentation](https://github.com/zoobz-io/capitan) - Event system details
