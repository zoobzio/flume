...
Complete reference for Flume's observability events using [Capitan](https://github.com/zoobz-io/capitan).
...
- [Capitan Documentation](https://github.com/zoobz-io/capitan) - Event system
