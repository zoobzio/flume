...
Flume emits [Capitan](https://github.com/zoobz-io/capitan) events throughout its lifecycle:
...
- [Quickstart](1.quickstart.md) - Build your first pipeline
- [Schema Design](../3.guides/1.schema-design.md) - Best practices
- [Events Reference](../4.reference/4.events.md) - All observability signals
