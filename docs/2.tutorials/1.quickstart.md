...
- [Building Pipelines](2.building-pipelines.md) - Complex schema patterns
- [Core Concepts](../1.learn/2.core-concepts.md) - Deeper understanding
- [Schema Format](../5.reference/2.schema-format.md) - Complete reference
