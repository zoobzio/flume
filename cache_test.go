...
func TestSignature(t *testing.T) {
	t.Run("BasicSignature", func(t *testing.T) {
		...
		expected := "plugz.TestData:plugz.TestKey:test"
	...
	t.Run("DifferentKeyValues", func(t *testing.T) {
		...
		expected1 := "plugz.User:plugz.UserKey:v1"
		expected2 := "plugz.User:plugz.UserKey:v2"
	...
	t.Run("DifferentKeyTypes", func(t *testing.T) {
		...
		expectedA := "plugz.Data:plugz.KeyA:test"
		expectedB := "plugz.Data:plugz.KeyB:test"
	...
	t.Run("DifferentDataTypes", func(t *testing.T) {
		...
		expectedA := "plugz.DataA:plugz.TestKey:test"
		expectedB := "plugz.DataB:plugz.TestKey:test"
	...
	t.Run("ComplexTypes", func(t *testing.T) {
		...
		expectedPrefix := "plugz.ComplexData:plugz.ComplexKey:"
	...
	t.Run("NumericKeys", func(t *testing.T) {
		...
		expected1 := "plugz.Data:plugz.IntKey:1"
		expected2 := "plugz.Data:plugz.IntKey:2"
