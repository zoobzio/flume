...
func TestSecurityPipeline(t *testing.T) {
	...
	contract := plugz.GetContract[examples.AuditableData](testKey)
...
func TestPipelineDiscovery(t *testing.T) {
	...
	contract1 := plugz.GetContract[examples.AuditableData](key1)
	...
	contract2 := plugz.GetContract[examples.AuditableData](key1)
