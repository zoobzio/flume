...
// Content Moderation Factory - Mock Services
// ==========================================
// Simulated external services for demonstration.
// Note: Identical to 'before' - the services don't change.
...
func (a *auditLogger) Log(_ context.Context, content Content) error {
	fmt.Printf("    [Audit] Content %s: status=%s, spam=%.2f, toxicity=%.2f\n",
		content.ID, content.Status, content.SpamScore, content.ToxicityScore)
	return nil
}
